...
public class Node2SimpleFlowController : MonoBehaviour
{
    [Header("Node Settings")]
    [SerializeField] private string nodeID = "Node2";
    [SerializeField] private string nodeSceneName = "Node2_1_HunterHunt";
    ...
    private IEnumerator Start()
    {
        ...
        {
            Debug.Log("Node2SimpleFlowController: entered Placement phase.");
            yield break;
        }
    ...
    {
        Debug.Log($"Node2SimpleFlowController: loading scene {sceneName}");
